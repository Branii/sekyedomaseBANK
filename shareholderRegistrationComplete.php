...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/bootstrap/bootstrap-theme.min.css"-->
    <link rel="stylesheet" type="text/css" href="../css/styles.css">
    <link rel="stylesheet" type="text/css" href="shareholder_photo/css/style.css">
  </head>
<body>
<nav class="">
    <div class="container-fluid">
      <div class="row nav-pane">
        <div class="pull-left current-page">SHAREHOLDER</div>
      ...
      <div class="container-fluid">
        <div class="login-page">
          <div class="form center">
            <p class="head center-text">SHAREHOLDER REGISTRATION COMPLETE!</p>
                <div class="row">
                  <div class="col-xs-2">   </div>   
                  <div class="col-xs-8"><span onclick="window.location.replace('addshareholder.php')" class="upload_btn">Register New Shareholder</span></div>
                  <div class="col-xs-2">   </div> 
                </div>
                <br>
                <div class="row">
                  <div class="col-xs-2">   </div>   
                  <div class="col-xs-8"><span onclick="window.location.replace('shareholders.php')" class="upload_btn">View All Shareholders</span></div>
                  <div class="col-xs-2">   </div> 
                </div>  
          </div>
        </div>
